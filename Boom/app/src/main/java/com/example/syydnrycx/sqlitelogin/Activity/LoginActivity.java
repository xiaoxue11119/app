...
*/
    ...
    private boolean judPhone() {//判断手机号是否正确
        ...
        {
            Toast.makeText(LoginActivity.this,"Please enter your telephone number",Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(LoginActivity.this,"Your telephone number is out of digits",Toast.LENGTH_LONG).show();
        ...
        //正确的情况
            ...
            if(phone_number.matches(num)) {
                ...
                Toast.makeText(LoginActivity.this,"Please input the correct mobile phone number",Toast.LENGTH_LONG).show();
                return false;
            }
        }
    }
    ...
    private boolean judCord() {//判断验证码是否正确
        ...
        if(TextUtils.isEmpty(edit_cord.getText().toString().trim())) {//验证码
            Toast.makeText(LoginActivity.this, "Please enter your verification code", Toast.LENGTH_LONG).show();
            edit_cord.requestFocus();//聚集焦点
            return false;
        }
        else if(edit_cord.getText().toString().trim().length()!=4){
            Toast.makeText(LoginActivity.this,"Your verification code is out of digits",Toast.LENGTH_LONG).show();
        ...
        public void handleMessage(Message msg) {
            ...
            if (result==SMSSDK.RESULT_COMPLETE){
                if (event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE) {//提交验证码成功
                    Toast.makeText(getApplicationContext(), "The verification code is entered correctly",Toast.LENGTH_LONG).show();
                }
            }else {//其他出错情况
                if(coreflag){
                    ...
                    Toast.makeText(getApplicationContext(),"Verification code input error", Toast.LENGTH_LONG).show();
                }
